...
m0 = [2,1.2,0.1,0.15,0.03,deg2rad(25), deg2rad(40), deg2rad(55), deg2rad(90),deg2rad(90)]
ρ = 1.
...
sh = [VMeasure(dobs[2np+2k-1],exp(dobs[2np+2k]),.01,0.01) for k in 1:nsh]

# a prior moel parameters
m1 = [2.2,1.3,0.0,0.0,0.,deg2rad(25), deg2rad(40), deg2rad(55), deg2rad(90),deg2rad(90)]
